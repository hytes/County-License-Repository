...
<head>
  ...
  <title>Welcome to County Council of Eldoret</title>
        ...
        <thead>
            <tr>
                ...
                <th><i class="icon-user"></i>License Number</th>
                 <th><i class="icon-envelope"></i>License Type</th>
                <th><i class="icon-envelope"></i>Business Name</th>
                <th><i class="icon-envelope"></i> Business Location</th>
                <th><i class="icon-home"></i> Date </th>
            </tr>
        </thead>
        <tbody>
	<?php foreach($landdetails as $detail): ?>
            <tr>
