        ...
        <div class="span3">
         <p>&copy; Copyright 2014.</p>
          ...
          <div class="span2">
              ...
              <a class="btn btn-info btn-small" href="<?php echo site_url('council/generatePdf'); ?>">
                      <i class="icon icon-print"></i>Print Receipt &raquo;</a>
          </div> 
    </div>
    </div>
  </footer>
