...
<div class="span8">
    ...
    <div class="row">
        <div class="span10">
		<?php echo form_open('council/license_pay'); ?>
                <fieldset>
                <legend>License Application Details</legend>
                    <div class="span4">
			...
			<input type="text" name="reference" value="001" style="display: none;"/>
                        ...
                        <select name="ltype">
                            <option>Single Business Unit   ksh1,000</option>
                            <option>General Business  ksh2,000 </option>
